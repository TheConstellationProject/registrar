...
/*
 *
 * ZeroTierOne.h v0.1 ALPHA by the Arachnid Network Team
 * Modified for use on the Arachnid Network
 *
 */
 ...
 */
#define ZT_MAX_NETWORK_ROUTES 4096

/**
 * Maximum number of statically assigned IP addresses per network endpoint using ZT address management (not DHCP)
 */
#define ZT_MAX_ZT_ASSIGNED_ADDRESSES 4096 
